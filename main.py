...
def list_mongodb_collection_names(database):
    pooja = pymongo.MongoClient(
        "mongodb+srv://Guvi:Poojas123@atlascluster.a9h50me.mongodb.net/?retryWrites=true&w=majority"
        )
    db = pooja[database]
...
def sql_create_tables():
    pooja_sql = psycopg2.connect(host='localhost', user='postgres', password='Poojas1#', database='Youtube_data_harvesting')
    cursor = pooja_sql.cursor()
...
def list_sql_channel_names():
    pooja = psycopg2.connect(host='localhost', user='postgres', password='Poojas1#', database='Youtube_data_harvesting')
    cursor = pooja.cursor()
...
def sql_channel(database, col_input):
    pooja_mdb = pymongo.MongoClient(
        "mongodb+srv://Guvi:Poojas123@atlascluster.a9h50me.mongodb.net/?retryWrites=true&w=majority")
    db = pooja_mdb[database]
    col = db[col_input]
...
def channels_totalchannels():
    ...
    pooja_s = psycopg2.connect(host='localhost', user='postgres', password='Poojas1#', database='Youtube_data_harvesting')
    cursor = pooja_s.cursor()
